...
<body>
    <div class="form-container">
        ...
        <form:form modelAttribute="mascota" method="POST" action="/mascotas/actualizar/${mascota.id}" class="needs-validation">
            <!-- Nombre -->
            ...
            <div class="form-group">
                ...
                <form:input path="raza" type="text" class="form-control"/>
            ...
            <div class="form-group">
                ...
                <form:input path="pesoKg" type="number" class="form-control" step="0.1"/>
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <a href="/mascotas/detalle/${mascota.id}" class="btn btn-secondary btn-lg">Cancelar</a>
